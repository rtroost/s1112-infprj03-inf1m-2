...
class registreer_cont extends CI_controller{
	...
	$this->form_validation->set_rules('reg_email','email','valid_email|required');
	...
	$this->form_validation->set_message('valid_email', 'Gelieve een geldig e-mailadres in te vullen.');
