		...
		<header>
			...
			<nav>
				<ul id="header_nav">
					...
					<li>
						<a href="<?php echo base_url();?>index.php/bestellen_cont"><img onmouseover="this.src='<?php echo base_url();?>images/img_button_bestellen_over.png' " onmouseout="this.src='<?php $pos = strpos($_SERVER['REQUEST_URI'], "bestellen_"); if($pos > 0) { echo base_url()."images/img_button_bestellen_over.png";} else{ echo base_url()."images/img_button_bestellen.png";} ?>'" src="<?php $pos = strpos($_SERVER['REQUEST_URI'], "bestellen_"); if($pos > 0) { echo base_url()."images/img_button_bestellen_over.png";} else{ echo base_url()."images/img_button_bestellen.png";} ?>" /></a>
					</li>
					<li>
						<a href="<?php echo base_url();?>index.php/contact_cont"><img onmouseover="this.src='<?php echo base_url();?>images/img_button_contact_over.png' " onmouseout="this.src='<?php $pos = strpos($_SERVER['REQUEST_URI'], "contact_cont"); if($pos > 0 and $this->session->userdata('typeid') != 2) { echo base_url()."images/img_button_contact_over.png";} else{ echo base_url()."images/img_button_contact.png";} ?>'" src="<?php $pos = strpos($_SERVER['REQUEST_URI'], "contact_cont"); if($pos > 0 and $this->session->userdata('typeid') != 2) { echo base_url()."images/img_button_contact_over.png";} else{ echo base_url()."images/img_button_contact.png";} ?>" /></a>
					</li>
					<li>
				...
				<div id="sumenu">
					<nav id="navSub">
						<?php if(strpos($_SERVER['REQUEST_URI'], "bestellen_cont") > 0 or strpos($_SERVER['REQUEST_URI'], "selfmade_cont") > 0) { ?>
						<ul id="header_nav">
							<li>
								<a href="<?php echo base_url();?>index.php/bestellen_cont"><img src="<?php if(strpos($_SERVER['REQUEST_URI'], "bestellen_cont") > 0) { echo base_url();?>images/subMenu/bestellen/productenhethuis_over.png <?php } else { echo base_url();?>images/subMenu/bestellen/productenhethuis.png <?php } ?>" onmouseover="this.src='<?php echo base_url();?>images/subMenu/bestellen/productenHetHuis_over.png' " onmouseout="this.src='<?php if(strpos($_SERVER['REQUEST_URI'], "bestellen_cont") > 0) { echo base_url();?>images/subMenu/bestellen/productenhethuis_over.png <?php } else { echo base_url();?>images/subMenu/bestellen/productenhethuis.png <?php } ?>'"/></a>
							</li>
							<li>
						...
						<ul id="header_nav">
							...
							<li>
								<a href="<?php echo base_url();?>index.php/user/edit"><img src="<?php if(strpos($_SERVER['REQUEST_URI'], "edit") > 0) { echo base_url();?>images/subMenu/mijnAccount/mijnGegevens_over.png <?php } else { echo base_url();?>images/subMenu/mijnAccount/mijnGegevens.png <?php } ?>" onmouseover="this.src='<?php echo base_url();?>images/subMenu/mijnAccount/mijnGegevens_over.png' " onmouseout="this.src='<?php if(strpos($_SERVER['REQUEST_URI'], "edit") > 0) { echo base_url();?>images/subMenu/mijnAccount/mijnGegevens_over.png <?php } else { echo base_url();?>images/subMenu/mijnAccount/mijnGegevens.png <?php } ?>'"/></a>
							</li>
							<li>
