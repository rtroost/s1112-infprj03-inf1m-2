...
<?php
	...
	<div id=\"navigatie\">
		Gearchiveerd: 
		<select id=\"gebruikersType\" name=\"gearchiveerd\" style=\"width:100px\" onchange=\"paginaType(this)\">
			<option value=\"0\">Nee</option>
			<option value=\"1\">Ja</option>
		</select>
	</div>
	
	<div id =\"zoekGebruiker\">	
		Zoek gebruiker: <input type=\"text\" id=\"zoekBeheer\" onkeyup=\"getSearch()\">
	</div>
	...
	for($i=0; $i < count($gebruikers); $i++)
	{
		...
		<table id=\"gebruikerTable\">	
			...
			<tr><td><input name=\"wijzigGebruiker\" id=\"wijzigGebruiker".$id."\" style=\"width:110px\" onmousedown=\"wijzigGebruiker(".$id.")\" type=\"button\" value=\"Wijzig\"></td><td><div id=\"resultaat".$id."\"></div></td></tr>
